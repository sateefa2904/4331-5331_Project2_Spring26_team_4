...
class zgt_tx {
 ...
 public:
  ...
  int semno;    // Txi uses semaphore i; sem 0 for TM
  ...
  void perform_read_write_operation(long, long, char); // ASantra[2/07/2026]: Added as a method to perform actual read/write operation in Spring 2026
